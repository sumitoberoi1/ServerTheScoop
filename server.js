...
function deleteComment(url, request) {
  ...
  if (savedComment) {
    console.log(savedComment.username);
    const updatedCommentIds = database.users[savedComment.username].commentIds.filter(function(index) {
     return index !== id;
   });
   const updatedArticleCommentIds = database.articles[savedComment.articleId].commentIds.filter(function(index) {
     return index !== id;
   });

  database.articles[savedComment.articleId].commentIds = updatedArticleCommentIds;
    database.users[savedComment.username].commentIds = updatedCommentIds;
